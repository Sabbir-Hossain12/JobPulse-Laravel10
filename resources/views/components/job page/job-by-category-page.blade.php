                            ...
                            <aside class="left_widgets p_filter_widgets price_rangs_aside sidebar_box_shadow">
                                ...
                                <div class="widgets_inner">
                                    <div class="range_item">
                                        ...
                                        <span class="irs js-irs-0"><span class="irs"><span class="irs-line" tabindex="-1"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min" style="visibility: hidden;">tk. 0</span><span class="irs-max" style="visibility: visible;">tk. 1.000</span><span class="irs-from" style="visibility: visible; left: 0%;">tk. 0</span><span class="irs-to" style="visibility: visible; left: 39.0411%;">tk. 500</span><span class="irs-single" style="visibility: hidden; left: 9.24658%;">tk. 0 - tk. 500</span></span><span class="irs-grid"></span><span class="irs-bar" style="left: 3.42466%; width: 46.5753%;"></span><span class="irs-shadow shadow-from" style="display: none;"></span><span class="irs-shadow shadow-to" style="display: none;"></span><span class="irs-slider from" style="left: 0%;"></span><span class="irs-slider to type_last" style="left: 46.5753%;"></span></span><input type="text" class="js-range-slider irs-hidden-input" value="" readonly="">
...
<script>
    ...
    async function jobList() {
        ...
        let res = await axios.get(`job-by-category/${categoryId}`)
